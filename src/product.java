...
public class product extends javax.swing.JFrame {
    ...
    private void tampil_product(){
        Object[]baris ={"id","outlet_id","image","name","slug","category_id","brand_id","description","price","created_by","updated_by","created_at","updated_at"};
        
        tabmode = new DefaultTableModel(null, baris);
        product.setModel(tabmode);
